...
export default function GeneratePage() {
  ...
  const handleBatchGenerate = async () => {
    ...
    try {
      ...
      setBatchJobs(
        result.jobs.map((job: { jobId: string }, i: number) => ({
          jobId: job.jobId,
          ...
          <div className="flex gap-1 p-1 bg-white/[0.03] border border-white/[0.06] rounded-xl w-fit mb-6">
            <button
              ...
              className={cn(
                ...
                mode === 'single'
                  ? 'bg-gradient-to-r from-fabric-600 to-fabric-500 text-white shadow-sm'
                ...
                <CardContent className="space-y-5">
                  {mode === 'single' && (
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        className={cn(
                          'w-full rounded-xl border bg-white/[0.03] px-3.5 py-2.5 text-sm text-gray-100 placeholder-gray-600 resize-none',
                          'transition-all duration-200 outline-none',
                          'focus:ring-2 focus:ring-fabric-500/30 focus:border-fabric-500/50',
                          promptError
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            selectedDim.label === dim.label
                              ? 'border-fabric-500/40 bg-fabric-500/10 text-fabric-300'
                              : 'border-white/[0.08] bg-white/[0.03] text-gray-400 hover:border-white/[0.15] hover:text-gray-300'
                          )}
                        >
                          {dim.label}
                        </button>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className={cn(
                        'w-full rounded-xl border bg-white/[0.03] px-3.5 py-2 text-sm text-gray-100 placeholder-gray-600',
                        'transition-all duration-200 outline-none',
                        'focus:ring-2 focus:ring-fabric-500/30 focus:border-fabric-500/50',
                        'border-white/[0.08] hover:border-white/[0.15]'
                      )}
                    ...
                    <>
                      {!singleJobId ? (
                        <div className="flex flex-col items-center justify-center h-80 rounded-xl border border-dashed border-white/[0.08] bg-white/[0.01]">
                          <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-fabric-500/15 to-fabric-600/15 border border-fabric-500/20 flex items-center justify-center mb-4">
